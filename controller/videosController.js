...
const { cloudinaryVideo } = require("../cloudinary/cloudinary");
...
const postVideo = async (req, res) => {
  ...
  let upload;
  try {
    upload = await cloudinaryVideo(dataURI);
  } catch (error) {
    res.send({ succes: false, message: "Video is not uploaded on cloudinary" });
  }
